            ...
            <div class="row vh-100">
                <div class="col-12 col-md-4">
                    <div class="card border-0 rounded shadow">
                        <div class="card-body">
                            <h4 class="text-info">Update Contact</h4>
                            <hr>
                            <?php
                            function user(){
                                $id = $_GET['id'];
                            ...
                            ?>
                            <form action="update.php?<?php user()['id'] ?>" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                                <div class="form-group">
                                    <label for="name">Name</label>
                                    <input type="text" name="name" class="form-control" id="name" placeholder="Name" value="<?php echo user()['name'];?>" required min="5" max="20">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phone" class="form-control" id="phone" placeholder="Phone" value="<?php echo user()['phone'];?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="upload[]" class="form-control p-1" id="upload" placeholder="Phone" value="<?php user()['photo_link'] ?>" accept="image/jpeg,image/png" multiple required>
                ...
                <div class="col-12 col-md-8">
                    <div class="card border-0 rounded shadow">
                        <div class="card-body">
                            <h4 class="text-info">Contact Lists</h4>
                            <hr>
                            <table class="table">
                                <thead>
                                <tr>
                                ...
                                <?php foreach (users() as $u){ ?>
                                    <tr>
                                        ...
                                        <td class="align-middle text-nowrap">
                                            ...
                                            <a href="" class="btn btn-outline-warning"><i class="feather-edit"></i></a>
                                        </td>
                                        <td class="align-middle">
